-- Verificar se o template existe e inserir se não existir
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM email_templates WHERE name = 'feedback_request') THEN
...
<body>
    ...
    <div class="footer">
        ...
        RAISE NOTICE 'Template de email inserido com sucesso';
    ELSE
        RAISE NOTICE 'Template de email já existe';
    END IF;
END $$; 